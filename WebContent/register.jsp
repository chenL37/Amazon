			...
			<form id="regForm" method="post" action="doAction?action=register" onsubmit="return checkForm(this)" ><!-- onsubmit="return checkForm(this)" -->
				<table>
					...
					<tr>
						...
						<td><input value="sa@sina.com" class="text" type="text" id="email" name="email" onfocus="FocusItem(this)" onblur="CheckItem(this)"/><span id="uemail"></span></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input class="text verycode" type="text" id="veryCode" name="veryCode" onfocus="FocusItem(this)" onblur="CheckItem(this);" maxlength="4"/><img id="veryCode" src="code.jsp" /><span id="Code"></span></td>
					</tr>
					<tr>
						<td></td>
