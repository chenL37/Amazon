	...
	<div id="shopping">
		<form action="doBuy" method="post">
			<table id="oderview">
				...
				<tr id="${od.hp_id}">
					<td class="thumb"><img style="width: 100px; height: 100px;" src="${od.product.hp_file_name }" />
						<a href="doAction?action=productView&pId=${od.hp_id }">${od.product.hp_Name }</a>
					</td>
					<td class="price" >
						￥<span >单价：${od.product.hp_price }</span>
					</td>
					<td class="number">
							<span>X${od.hodQuantity_Number }</span>
					</td>
