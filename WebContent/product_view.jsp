...
<body>
	...
	<div id="position" class="wrap">
		...
		<a href="doAction?action=page&cate=parent&hpcId=${parent_category.hpc_id }">${parent_category.hpc_name }</a> &gt; <a
			href="doAction?action=page&cate=child&hpcId=${child_category.hpc_id }">${child_category.hpc_name }</a>
	</div>
